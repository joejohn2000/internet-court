...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-court-case-secret-key')
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'core.authenticators.CsrfExemptSessionAuthentication',
...
# Important for POST requests between domains
